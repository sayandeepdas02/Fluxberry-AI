...
/* ═══════════════════════════════════════════════════
   SIDEBAR PROFILE — Workspace switcher + profile dropdown
   ═══════════════════════════════════════════════════ */
...
export function SidebarProfile({
  ...
  userName = "User",
  userEmail = "user@fluxberryai.com",
  planName = "Pro Plan",
  memberCount = 5,
  onLogout,
}: SidebarProfileProps) {
  ...
  return (
    <div className="relative p-3" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-2 right-2 top-[calc(100%)] z-50 mt-1 overflow-hidden rounded-xl border border-border bg-card shadow-2xl shadow-black/20">
          ...
          <div className="border-b border-border p-2">
            ...
            <button className="flex w-full items-center gap-2.5 rounded-lg px-2 py-2 text-sm transition-colors hover:bg-muted cursor-pointer">
            ...
            <button className="flex w-full items-center gap-2.5 rounded-lg px-2 py-2 text-sm font-medium text-primary transition-colors hover:bg-muted cursor-pointer">
      ...
      {/* Meta info */}
      <div className="mt-1 flex items-center gap-1.5 px-2 text-[11px] text-muted-foreground/60">
        <span>{planName}</span>
