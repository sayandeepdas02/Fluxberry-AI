        ...
        <div className="lg:grid lg:grid-cols-3 flex flex-col w-full gap-0 border border-line">
          ...
          <div className="md:flex lg:flex-col lg:h-full gap-0">
            <TestimonialCard 
              ...
              quote="Fluxberry AI has been a game-changer for us. Their service is top-notch and their team is incredibly responsive."
            ...
            <TestimonialCard 
              ...
              quote="We've seen incredible results with Fluxberry AI. Their expertise and dedication is simply unmatched."
              name="Rika Shinoda"
          ...
          <div className="md:flex lg:flex-col lg:h-full gap-0">
            ...
            <TestimonialCard 
              className="bg-background text-foreground border-b lg:border-r border-line hover:bg-muted/50 transition-colors"
              quote="We're extremely satisfied with Fluxberry AI. Their expertise and dedication have exceeded our expectations."
              name="John"
              role="CEO of Labsbo"
          ...
          <div className="md:flex lg:flex-col lg:h-full gap-0">
            <TestimonialCard 
              ...
              quote="Fluxberry AI has been a key partner in our growth journey."
              name="Guillermo Rauch"
              role="CEO of OdeaoLabs"
            ...
            <TestimonialCard 
              ...
              quote="Fluxberry AI has been a true game-changer for us. Their exceptional service, combined with their deep expertise and commitment to excellence, has made a significant impact on our business."
              name="Paul Brauch"
