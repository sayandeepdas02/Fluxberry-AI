        ...
        <section className="mb-32 px-4 max-w-5xl mx-auto">
            ...
            <div className="grid lg:grid-cols-5 gap-8 bg-background border border-border rounded-xl shadow-sm overflow-hidden p-6 md:p-10">
                ...
                <div className="lg:col-span-3 space-y-10 pr-0 md:pr-8">
                    <div>
                        <h3 className="text-xl mb-6">Platform Setup</h3>
                        <div className="space-y-8">
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    <label className="text-sm font-medium">Active Jobs</label>
                                    <span className="bg-muted px-2 py-1 rounded text-sm">{jobs}</span>
                                </div>
                                <input
                                    type="range"
                                    min="1"
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="bg-muted px-2 py-1 rounded text-sm">{resumes.toLocaleString()}</span>
                                </div>
                                <input
                                    type="range"
                                    min="100"
                    ...
                    <div className="pt-8 border-t border-border">
                        <h3 className="text-xl mb-3">AI Interviews & Assessments</h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4 p-4 bg-muted/60 rounded-lg border border-border mt-6">
                                <div className="flex-1">
                                    <div className="text-sm font-medium flex items-center gap-2">Combined Bundle <span className="bg-foreground text-background text-[10px] px-2 py-0.5 rounded-full uppercase tracking-wider">Save</span></div>
                                    <div className="text-xs text-muted-foreground mt-1">Run all 3 tests automatically on a single candidate pipeline.</div>
                                </div>
                                <input type="number" min="0" value={bundle} onChange={(e) => setBundle(Number(e.target.value))} className="w-24 px-3 py-2 border border-foreground/30 rounded-md bg-background text-sm text-center" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 bg-foreground text-background rounded-2xl p-8 flex flex-col justify-between shadow-xl mt-8 lg:mt-0">
                    <div>
                        <h3 className="text-2xl mb-8 text-background/90 text-center">Estimated Monthly Cost</h3>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between items-center border-b border-background/20 pb-4">
                                ...
                                <div className="text-lg">{basePlanCost === "Custom" ? "Custom" : `$${basePlanCost}`}</div>
                            </div>
                            <div className="flex justify-between items-center border-b border-background/20 pb-4">
                                ...
                                <div className="text-lg">${aiCost.toLocaleString()}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="flex justify-between items-end mb-8 bg-background/5 p-4 rounded-xl border border-background/10">
                            ...
                            <div className="text-4xl text-background">
