...
// ── Fit Analysis (heuristic-based scoring) ──────────────────
function generateFitAnalysis(p: Prospect) {
...
export default function TalentSearchPage() {
    ...
    const fitInsight = prospectDetail ? generateFitAnalysis(prospectDetail) : null
                                ...
                                {fitInsight && (
                                    <div className="space-y-3">
                                        <h4 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
                                            <Sparkles className="w-3.5 h-3.5 text-accent" /> Fit Analysis
                                        </h4>
                                        ...
                                        <div className="flex items-center justify-between p-3 bg-card/60 border border-line rounded-lg">
                                            <div>
                                                ...
                                                <p className="text-xl font-bold">{fitInsight.fitScore}%</p>
                                            </div>
                                            <div className={`px-2.5 py-1 rounded-full text-[11px] font-semibold ${
                                                fitInsight.fitScore >= 75 ? 'bg-emerald-500/10 text-emerald-400'
                                                : fitInsight.fitScore >= 50 ? 'bg-amber-500/10 text-amber-400'
                                                : 'bg-red-500/10 text-red-400'
                                            }`}>{fitInsight.fitLabel} Fit</div>
                                        </div>

                                        {fitInsight.strengths.length > 0 && (
                                            <div>
                                        ...
                                        <div className="p-3 bg-accent/5 border border-accent/10 rounded-lg">
                                            <p className="text-xs text-text-secondary leading-relaxed"><Zap className="w-3 h-3 inline mr-1 text-accent" />{fitInsight.suggestion}</p>
                                        </div>
                                        <p className="text-[10px] text-muted-foreground/40 text-center italic">Heuristic-based analysis · Derived from profile data</p>
                                    </div>
                                )}
